import unittest
import uuid
from main import Rate, User, login_user_with_google


class LoginUserWitchGoogleTests(unittest.TestCase):
    ...
    def test_login_user_valid_data(self):
        self.assertEqual(
            login_user_with_google(
                self.authenticated_user, "test@example.com"
            ),
    ...
    def test_login_user_invalid_data(self):
        self.assertIsNone(
            login_user_with_google(
                self.authenticated_user, "wrong@example.com"
            ),
